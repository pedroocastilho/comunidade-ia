...
#[Fillable(['name', 'email', 'password', 'phone', 'role', 'tem_acesso', 'acesso_expira_em', 'apelido', 'objetivo_principal', 'objetivo_secundario', 'tempo_disponivel', 'onboarding_completo_em', 'assinatura_status', 'perfil_ficticio', 'genero'])]
