...
<template>
    <section>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" :value="t('perfil.senhaAtual')" />
            ...
            <div>
                <InputLabel for="password" :value="t('perfil.novaSenha')" />
            ...
            <div>
                <InputLabel for="password_confirmation" :value="t('auth.confirmarSenha')" />
