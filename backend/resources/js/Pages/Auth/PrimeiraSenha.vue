...
<template>
    ...
    <div class="flex min-h-dvh flex-col items-center bg-aura-black px-5 py-10 text-aura-text sm:justify-center">
        ...
        <div class="mt-8 w-full max-w-md rounded-2xl border border-aura-line bg-aura-surface p-6 sm:p-8">
            <h1 class="break-words font-display text-2xl font-semibold">{{ t('primeiroAcesso.bemVindo') }} {{ apelido }} ✦</h1>
