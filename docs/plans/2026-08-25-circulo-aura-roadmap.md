...
| 6 | `2026-08-25-fase6-gamificacao.md` | Streak de check-ins, XP com níveis, conquistas (badges) no perfil. | ✅ concluída (2026-08-25) |
| 7 | `2026-08-25-fase7-premium.md` | Conteúdo premium avulso: lock 🔒, página de venda, webhook compra_aprovada, liberação automática. | ✅ concluída (2026-08-25) |
| 8 | `2026-08-25-fase8-comunidade.md` | Feed "O Círculo": posts, reações ✦, comentários, denúncias e moderação. | ✅ concluída (2026-08-25) |
